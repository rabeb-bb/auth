...
const Author = () => {
  ...
  useEffect(() => {
    dispatch(getAuthor(author._id));
    dispatch(getAuthorBooks(author._id));
  }, [dispatch]);
  const handleBook = (id) => {
    dispatch(getBook(id));
  };
            ...
            <div className="bg-white shadow rounded overflow-hidden">
              <div className="px-4 pt-0 pb-4 coverpro">
                <div className="media align-items-end profile-head">
                  ...
                  >
                    ...
                    />
                    {author._id === localStorage.getItem("authorID") ? (
                      <Link to="/account">
                  ...
                  <div className="media-body mb-5 text-white">
                    <h4 className="m-2">{`${author.first_name} ${author.last_name}`}</h4>
                  </div>
                </div>
              </div>
              ...
              <div className="px-4 py-3">
                ...
                <div className="p-4 rounded shadow-sm bg-light">
                  <p className="font-italic mb-0">{author.about_me}</p>
                </div>
              </div>
